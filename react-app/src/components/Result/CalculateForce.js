...
export const CalculateForce = (values) => {
    ...
    //         ha = reactions_PL(index).Ha; // yksittäisen pistekuormituksen vasen tukireaktio (vaaka)
    //         vb = reactions_PL(index).Vb; // yksittäisen pistekuormituksen oikea tukireaktio (pysty)
    ...
    // // var tulokset = { ...results, Vmax: maxmin[0], Vmin: maxmin[1], Mmax: maxmin[2], Mmin: maxmin[3] };
    // // setResults(tulokset);
    ...
    // return { shearData: shearData, momentData: momentData }
    return values;
